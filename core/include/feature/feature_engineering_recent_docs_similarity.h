...
class feature_engineering_recent_docs_similarity {
public:
    const int hash_size;
    const float jaccard_min_weight;
    const word2vec_model& w2v_model;
    feature_engineering_recent_docs_similarity(int hash_size, float jaccard_min_weight, const word2vec_model& w2v_model)
